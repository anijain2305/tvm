...
Expr QnnDenseLegalize (const Attrs& attrs,
...
.add_type_rel("QDense", DenseRel<QDenseAttrs, DenseType::kQnnDense>)
.set_attr<FTVMLegalize>("FTVMLegalize", QnnDenseLegalize);
