...
def tune_and_evaluate(tuning_opt, mod, params, data_shape, log_file,
        input_name):
...
def compile_via_tvm(sym, arg_params, aux_params, symbol_file, data_shape):
    ...
    log_file = "tuned_logs_pi3/" + "%s.log" % model_name
       ...
       tuning_option = {
           ...
           'measure_option': autotvm.measure_option(
               ...
               runner=autotvm.RPCRunner(
                   'janimesh_pi3',  # change the device key to your key
                   '0.0.0.0', 9190,
                   number=5, repeat=1, timeout=4)
           )
       }
    ...
    with autotvm.apply_history_best(log_file):
        with relay.build_config(opt_level=3):
            ...
            base = '/home/dlc/janimesh/tvm/mxnet_compiled_models_pi3/tvm_' + symbol_file.split('/')[-1].replace('.json','')
